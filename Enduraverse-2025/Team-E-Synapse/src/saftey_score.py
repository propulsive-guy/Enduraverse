...
def calculate_safety_score(accel_x, accel_y, accel_z, prev_accel_magnitude, prev_time):
...
try:
    while True:
        ...
        safety_score, prev_accel_magnitude, prev_time = calculate_safety_score(
            accel_x, accel_y, accel_z, prev_accel_magnitude, prev_time
        )
        
        safety_scores.append(safety_score)
        print(f"Real-time Safety Score: {safety_score}")
